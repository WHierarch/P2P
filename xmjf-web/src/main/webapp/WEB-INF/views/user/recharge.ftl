...
<#include "../include/user_siderbar.ftl">
    <div class="content fr">
        ...
        <form id="fm" method="post" action="${ctx}/account/addBusAccountRechagre" >
        <div class="recharge-main">
            <div class="recharge-bankCard">
                ...
                <div class="third-pay">
                    ...
                    <input type="text" class="recharge-input" name="picVerifyCode" id="pictureCode"
                ...
                <div class="third-pay">
                    <input type="button" value="确认充值" id="rechargeBut" class="recharge-but"/>
                    <span>${msg!}</span>
                </div>
                <div class="prompt">
